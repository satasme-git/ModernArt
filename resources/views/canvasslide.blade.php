...
<body>
            ...
            <div class="container" style="margin-top: 50px;">
                <h1 style="font-weight: bold;">Canvas Stretching</h1>
                <br>

                <div class="row">
                    <div class="col">
                         <img src="/images/canvasslide.jpg" width="100%" height="100%" alt="">
                    </div>
                    <div class="col" style="color: #1B571B;">
                          <b>Canvas Stretching</b>
                          <br><br>
