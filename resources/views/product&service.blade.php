...
<body>
    ...
    <div class="container" style="margin-top: 40px;">
          <center><h1>Shop by Products and Services</h1>
          <hr style="width: 30%;">
          </center>
    </div>
    
    <div style="border: outset #E0E0E0 1px; margin-left:10px; margin-right:10px; margin-bottom:10px;">
            <div class="container" style="text-align: center; margin-top:60px; ">
                <div class="row">
                    <div class="col" id="thumbnail">
                       <img src="/images/product1.jpg" width="70%" height="80%" alt="">
                       <div class="caption">
                           <b style="margin-left: 30px; margin-right: 30px;">Framing</b><br>
                           <a href="/frame"><button class="btn1">View</button></a>
