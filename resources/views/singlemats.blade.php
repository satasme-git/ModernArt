...
<body>
           ...
           <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="height: 40px;">
            ...
            <div class="container" style="margin-top: 30px;">
                <div class="row">
                    <div class="col-4">
                        <h1 style="font-size: 50px; color: #A1A361; font-weight:bold;">Single Mats</h1>
                    </div>
                    <div class="col-8">
                        <div style="width: 80%; height:80%; border-style: groove; ">
                                <center style="margin-top:30px; margin-bottom:10px;"><img src="/images/singlemats.jpg" width="90%" height="90%" alt=""></center>
                        </div>    
